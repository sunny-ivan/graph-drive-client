...
export function deserializeIntoStandardizePostRequestBody(standardizePostRequestBody: Partial<StandardizePostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "mean": n => { standardizePostRequestBody.mean = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "standardDev": n => { standardizePostRequestBody.standardDev = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "x": n => { standardizePostRequestBody.x = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
