...
export function deserializeIntoZ_TestPostRequestBody(z_TestPostRequestBody: Partial<Z_TestPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "sigma": n => { z_TestPostRequestBody.sigma = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "x": n => { z_TestPostRequestBody.x = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
