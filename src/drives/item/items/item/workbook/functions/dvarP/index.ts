...
export function deserializeIntoDvarPPostRequestBody(dvarPPostRequestBody: Partial<DvarPPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "criteria": n => { dvarPPostRequestBody.criteria = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "database": n => { dvarPPostRequestBody.database = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "field": n => { dvarPPostRequestBody.field = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
