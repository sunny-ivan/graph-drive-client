...
export function deserializeIntoMidbPostRequestBody(midbPostRequestBody: Partial<MidbPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "numBytes": n => { midbPostRequestBody.numBytes = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "startNum": n => { midbPostRequestBody.startNum = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "text": n => { midbPostRequestBody.text = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
