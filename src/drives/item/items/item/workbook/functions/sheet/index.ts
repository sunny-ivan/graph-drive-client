 ...
 * @param SheetPostRequestBody The instance to deserialize into.
...
export function deserializeIntoSheetPostRequestBody(sheetPostRequestBody: Partial<SheetPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "value": n => { sheetPostRequestBody.value = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param SheetPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeSheetPostRequestBody(writer: SerializationWriter, sheetPostRequestBody: Partial<SheetPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!sheetPostRequestBody || isSerializingDerivedType) { return; }
