 ...
 * @param CoupNumPostRequestBody The instance to deserialize into.
 ...
 * @param CoupNumPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeCoupNumPostRequestBody(writer: SerializationWriter, coupNumPostRequestBody: Partial<CoupNumPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!coupNumPostRequestBody || isSerializingDerivedType) { return; }
