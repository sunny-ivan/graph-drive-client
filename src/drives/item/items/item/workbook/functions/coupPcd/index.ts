 ...
 * @param CoupPcdPostRequestBody The instance to deserialize into.
...
export function deserializeIntoCoupPcdPostRequestBody(coupPcdPostRequestBody: Partial<CoupPcdPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "basis": n => { coupPcdPostRequestBody.basis = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "frequency": n => { coupPcdPostRequestBody.frequency = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "maturity": n => { coupPcdPostRequestBody.maturity = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "settlement": n => { coupPcdPostRequestBody.settlement = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
 * Serializes information the current object
 * @param CoupPcdPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeCoupPcdPostRequestBody(writer: SerializationWriter, coupPcdPostRequestBody: Partial<CoupPcdPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!coupPcdPostRequestBody || isSerializingDerivedType) { return; }
