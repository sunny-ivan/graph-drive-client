...
export function deserializeIntoTruncPostRequestBody(truncPostRequestBody: Partial<TruncPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "number": n => { truncPostRequestBody.number = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "numDigits": n => { truncPostRequestBody.numDigits = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
