 ...
 * @param TbillEqPostRequestBody The instance to deserialize into.
 ...
 * @param TbillEqPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeTbillEqPostRequestBody(writer: SerializationWriter, tbillEqPostRequestBody: Partial<TbillEqPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!tbillEqPostRequestBody || isSerializingDerivedType) { return; }
