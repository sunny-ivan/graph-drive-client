 ...
 * @param RadiansPostRequestBody The instance to deserialize into.
 ...
 * @param RadiansPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeRadiansPostRequestBody(writer: SerializationWriter, radiansPostRequestBody: Partial<RadiansPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!radiansPostRequestBody || isSerializingDerivedType) { return; }
