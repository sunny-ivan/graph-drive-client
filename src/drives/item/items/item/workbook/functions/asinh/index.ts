 ...
 * @param AsinhPostRequestBody The instance to deserialize into.
 ...
 * @param AsinhPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeAsinhPostRequestBody(writer: SerializationWriter, asinhPostRequestBody: Partial<AsinhPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!asinhPostRequestBody || isSerializingDerivedType) { return; }
