...
// @ts-ignore
import { ColumnWithColumn1RequestBuilderRequestsMetadata, type ColumnWithColumn1RequestBuilder } from './columnWithColumn1/index.js';
// @ts-ignore
...
// @ts-ignore
import { RowWithRow1RequestBuilderRequestsMetadata, type RowWithRow1RequestBuilder } from './rowWithRow1/index.js';
// @ts-ignore
...
export interface CellWithRowWithColumnRequestBuilder extends BaseRequestBuilder<CellWithRowWithColumnRequestBuilder> {
     ...
     */
     columnWithColumn1(column1: number | undefined) : ColumnWithColumn1RequestBuilder;
    /**
     * Gets the range object containing the single cell based on row and column numbers. The cell can be outside the bounds of its parent range, so long as it's stays within the worksheet grid.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<WorkbookRange>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/worksheet-cell?view=graph-rest-1.0|Find more info here}
     */
     ...
     */
     rowWithRow1(row1: number | undefined) : RowWithRow1RequestBuilder;
    /**
     * Gets the range object containing the single cell based on row and column numbers. The cell can be outside the bounds of its parent range, so long as it's stays within the worksheet grid.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const CellWithRowWithColumnRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/cell(row={row},column={column})";
/**
