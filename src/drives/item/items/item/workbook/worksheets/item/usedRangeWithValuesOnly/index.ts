 ...
 */
export const UsedRangeWithValuesOnlyRequestBuilderNavigationMetadata: Record<Exclude<keyof UsedRangeWithValuesOnlyRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
