 ...
 */
export const UsedRangeRequestBuilderNavigationMetadata: Record<Exclude<keyof UsedRangeRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
