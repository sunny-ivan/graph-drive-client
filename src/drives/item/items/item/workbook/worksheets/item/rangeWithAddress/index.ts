 ...
 */
export const RangeWithAddressRequestBuilderNavigationMetadata: Record<Exclude<keyof RangeWithAddressRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
