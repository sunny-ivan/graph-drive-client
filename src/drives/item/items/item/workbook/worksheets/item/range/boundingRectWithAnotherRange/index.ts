 ...
 */
export const BoundingRectWithAnotherRangeRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range()/boundingRect(anotherRange='{anotherRange}')";
/**
