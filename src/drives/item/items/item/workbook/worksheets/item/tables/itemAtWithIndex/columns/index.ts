...
// @ts-ignore
import { createWorkbookTableColumnCollectionResponseFromDiscriminatorValue, createWorkbookTableColumnFromDiscriminatorValue, serializeWorkbookTableColumn, type WorkbookTableColumn, type WorkbookTableColumnCollectionResponse } from '../../../../../../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const ColumnsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/itemAt(index={index})/columns{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}";
/**
