...
// @ts-ignore
import { createWorkbookChartPointCollectionResponseFromDiscriminatorValue, createWorkbookChartPointFromDiscriminatorValue, serializeWorkbookChartPoint, type WorkbookChartPoint, type WorkbookChartPointCollectionResponse } from '../../../../../../../../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const PointsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/itemAt(index={index})/points{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}";
/**
