...
// @ts-ignore
import { createDriveItemFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeDriveItem, type BaseCollectionPaginationCountResponse, type DriveItem } from '../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const SearchWithQRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/search(q='{q}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
