...
// @ts-ignore
import { createDriveItemFromDiscriminatorValue, createItemReferenceFromDiscriminatorValue, serializeDriveItem, serializeItemReference, type DriveItem, type ItemReference } from '../../../../../models/index.js';
// @ts-ignore
