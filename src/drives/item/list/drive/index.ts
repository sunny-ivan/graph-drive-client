...
// @ts-ignore
import { createDriveFromDiscriminatorValue, type Drive } from '../../../../models/index.js';
// @ts-ignore
 ...
 */
export const DriveRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/drive{?%24expand,%24select}";
/**
