...
// @ts-ignore
import { createListItemCollectionResponseFromDiscriminatorValue, createListItemFromDiscriminatorValue, serializeListItem, type ListItem, type ListItemCollectionResponse } from '../../../../models/index.js';
// @ts-ignore
 ...
 */
export const ItemsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
