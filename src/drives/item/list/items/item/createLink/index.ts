...
// @ts-ignore
import { createDriveRecipientFromDiscriminatorValue, createPermissionFromDiscriminatorValue, serializeDriveRecipient, serializePermission, type DriveRecipient, type Permission } from '../../../../../../models/index.js';
// @ts-ignore
