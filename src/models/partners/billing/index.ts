...
// @ts-ignore
import { createPublicErrorFromDiscriminatorValue, deserializeIntoEntity, LongRunningOperationStatus, LongRunningOperationStatusObject, serializeEntity, serializePublicError, type Entity, type PublicError } from '../../index.js';
// @ts-ignore
