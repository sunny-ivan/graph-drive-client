...
// @ts-ignore
import { createUserFromDiscriminatorValue, deserializeIntoEntity, serializeEntity, serializeUser, type Entity, type User } from '../index.js';
// @ts-ignore
import { type AdditionalDataHolder, type Parsable, type ParseNode, type SerializationWriter } from '@microsoft/kiota-abstractions';

export type AccountType = (typeof AccountTypeObject)[keyof typeof AccountTypeObject];
export interface AssignedTelephoneNumber extends AdditionalDataHolder, Parsable {
    /**
...
export interface EffectivePolicyAssignment extends AdditionalDataHolder, Parsable {
    /**
     * The OdataType property
     */
    odataType?: string | null;
...
export interface PolicyAssignment extends AdditionalDataHolder, Parsable {
    /**
