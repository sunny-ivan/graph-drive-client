...
// @ts-ignore
import { BinaryOperator, BinaryOperatorObject, createPublicErrorFromDiscriminatorValue, deserializeIntoEntity, serializeEntity, serializePublicError, type Entity, type PublicError } from '../';
// @ts-ignore
